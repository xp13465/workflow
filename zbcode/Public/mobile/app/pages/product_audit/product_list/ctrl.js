(function(){
    var ctrl = $M.ctrl.extend({
        ...
        __gotoitem__ : function(li){
            ...
            // App.linkPage({
            //     loads : {
            //         remotedataUrl : url, //远程获取数据的url
            //         templateUrl : "/Public/mobile/app/pages/product_audit/product_list/view.html",
            //         ctrljsUrl : "/Public/mobile/app/pages/product_audit/product_list/ctrl.js",   //js地址
            //         csscodeUrl : "/Public/mobile/app/pages/product_audit/product_list/css.css",  //js地址
            //         ctrls : ""
            //     },
        ...
        __view_details__ : function( b ){
            ...
            App.linkPage({
                loads : {
                    ...
                    templateUrl : "/Public/mobile/app/pages/product_audit/product_detail/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/product_audit/product_detail/ctrl.js",   //js地址
                    csscodeUrl : "/Public/mobile/app/pages/product_audit/product_detail/css.css",  //js地址
                    ctrls : ""
                },
