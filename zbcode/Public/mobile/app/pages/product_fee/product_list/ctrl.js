        ...
        __view_details__ : function( b ){
            ...
            App.linkPage({
                loads : {
                    ...
                    templateUrl : "/Public/mobile/app/pages/product_fee/product_detail/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/product_fee/product_detail/ctrl.js",   //js地址
                    csscodeUrl : "/Public/mobile/app/pages/product_fee/product_detail/css.css",  //js地址
                    ctrls : ""
                },
                postData : {id:params.id,status:status},
                width : this.elWidth,
                height : this.elHeight,
                 fatherPage : me.getPage()  //////dsdsdsds
            });
        },
