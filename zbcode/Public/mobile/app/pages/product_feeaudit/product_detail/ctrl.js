    ...
    var ctrl = $M.ctrl.extend({
        ...
        __view_feeinfo__ : function( b ){
            ...
            App.linkPage({
                loads : {
                    remotedataUrl : "/product/getProductInfo", //远程获取数据的url
                    templateUrl : "/Public/mobile/app/pages/product_feeaudit/product_feeinfo/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/product_feeaudit/product_feeinfo/ctrl.js",   //js地址
                    csscodeUrl : "/Public/mobile/app/pages/product_feeaudit/product_feeinfo/css.css",  //js地址
                    ctrls : ""
                },
                postData : {id:params.id},
                width : this.elWidth,
