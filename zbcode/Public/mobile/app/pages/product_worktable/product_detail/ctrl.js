    ...
    var ctrl = $M.ctrl.extend({
        ...
        __view_scoreresult__ : function( b ){
            ...
            App.linkPage({
                loads : {
                    remotedataUrl : "/product/getProductInfo", //远程获取数据的url
                    templateUrl : "/Public/mobile/app/pages/product_worktable/product_scoreresult/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/product_worktable/product_scoreresult/ctrl.js",   //js地址
                    csscodeUrl : "/Public/mobile/app/pages/product_worktable/product_scoreresult/css.css",  //js地址
                    ctrls : ""
                },
                postData : {id:params.id},
                width : this.elWidth,
        ...
        __view_rate__ : function( b ){
            ...
            App.linkPage({
                loads : {
                    remotedataUrl : "/product/getProductInfo", //远程获取数据的url
                    templateUrl : "/Public/mobile/app/pages/product_worktable/product_rateview/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/product_worktable/product_rateview/ctrl.js",   //js地址
                    csscodeUrl : "/Public/mobile/app/pages/product_worktable/product_rateview/css.css",  //js地址
                    ctrls : ""
                },
                postData : {id:params.id},
                width : this.elWidth,
