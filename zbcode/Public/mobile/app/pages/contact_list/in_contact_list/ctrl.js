(function(){
    var ctrl = $M.ctrl.extend({
        ...
        __click_out_contact__ : function( b ){
            var me = this;
            var params = me.__getParams( b );
            App.linkPage({
                loads : {

                    remotedataUrl : "/user/getProductCustomerList", //远程获取数据的url
                    templateUrl : "/Public/mobile/app/pages/contact_list/out_contact_list/view.html",
                    ctrljsUrl : "/Public/mobile/app/pages/contact_list/out_contact_list/ctrl.js",   //js地址
                    ctrls : ""
                },
