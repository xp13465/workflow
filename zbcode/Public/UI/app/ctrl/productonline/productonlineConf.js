...
Ext.define('ui.ctrl.productonline.productonlineConf',{
    ...
    _scFields : [
        ...
        {fieldLabel : '线上状态' ,labelWidth : 70,editable:false, name : 'status' , fieldtype : 'Ext.form.field.ComboBox',displayField	: 'display', valueField 	: "value", value : 0,
            store : new Ext.data.ArrayStore({
                fields	: 	['value', 'display'],
                data	:	[[0,'不限'],[6,'销售中'],[10,'暂下架']]
            }), pmsCode:'' , checkpms:0   },
