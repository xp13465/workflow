 ...
 */
Ext.define('ui.ctrl.productmeeting.productmeetingConf',{
    extend: 'ui.extend.baseClass.baseConf',
    modelName : "产品上会审核区",
    topicalName : '产品上会审核区',
    modelCode : 'productmeeting',
    groupCode : '',
    requires : [
        'ui.view.productmeeting.Coms.extraFieldPanel'
    ],
    ...
    _urls : {  //productFirstSubmit
        'get.productmeeting.list' : { url : "Product/getProductWaitMeetingList" , 'pmsCode' : 'get.productmeeting.list' , checkpms : 0 },
        'get.productcancel' : { url : "Product/productRevoke" , 'pmsCode' : 'get.productmeeting.info' , checkpms : 0 },
        'get.productsubmit' : { url : "Product/passProductMeeting" , 'pmsCode' : 'get.productmeeting.info' , checkpms : 0 },
        'get.productunsubmit' : { url : "Product/backProductMeeting" , 'pmsCode' : 'get.productmeeting.info' , checkpms : 0 }
    },
    ...
    _lstOpButtons : [
        { text : '查看' , pmsCode : 'productmeeting.view' , permissionCode : 'product.view', recKey : ['id']/*所需record之关键字列表*/  , checkpms:0, iconCls : ''},
        { text : '通过' , pmsCode : 'productmeeting.submit'  , permissionCode : 'product.submit', recKey : ['id']/*所需record之关键字列表*/  , checkpms:0 ,iconCls : ''},
        { text : '不通过' , pmsCode : 'productmeeting.unsubmit'  , permissionCode : 'product.submit', recKey : ['id']/*所需record之关键字列表*/  , checkpms:0 ,iconCls : ''},
        { text : '撤销' , pmsCode : 'productmeeting.cancel'  , permissionCode : 'product.cancel', recKey : ['id']/*所需record之关键字列表*/  , checkpms:0 ,iconCls : ''}
    ],
    ...
    * */
    ...
    _listGridHeader : [
        ...
        { header: '我是否参与过审核', width: 180,  dataIndex: 'is_check' , renderer : function(v){
            if(v == 1){
                return '我参与过';
            }else if(v == 2){
                return '我未参与';
