 ...
 */
Ext.define('ui.ctrl.productleadermeeting.productleadermeetingConf',{
    extend: 'ui.extend.baseClass.baseConf',
    modelName : "预录产品查看区",
    topicalName : '预录产品查看区',
    modelCode : 'productleadermeeting',
    groupCode : '',
    requires : [
        'ui.view.productleadermeeting.Coms.extraFieldPanel'
    ],
    ...
    _urls : {  //productFirstSubmit
        'get.productleadermeeting.list' : { url : "Product/getProductMeetingList" , 'pmsCode' : 'get.productleadermeeting.list' , checkpms : 0 },
        'get.productcancel' : { url : "Product/productRevoke" , 'pmsCode' : 'get.productcancel' , checkpms : 0 },
        'get.productunsubmit' : { url : "Product/backproductleadermeeting" , 'pmsCode' : 'get.productleadermeeting.info' , checkpms : 0 }
    },
    ...
    _lstOpButtons : [
        { text : '查看' , pmsCode : 'productleadermeeting.view' , permissionCode : 'product.view', recKey : ['id']/*所需record之关键字列表*/  , checkpms:0, iconCls : ''}
    ],
