 ...
 */
Ext.define( 'ui.view.user.userView', {
    extend: 'ui.extend.baseClass.baseView',
    alias: 'widget.userviewpanel',
    layout  : 'border',
    uses : [
        'ui.view.user.Coms.pageHeader',
        'ui.view.user.Coms.pageCenter'
    ],
    ...
    initComponent : function(){
        this.pageheader =  Ext.create('ui.view.user.Coms.pageHeader',{ctrl : this.ctrl});
        this.pagecenter =  Ext.create('ui.view.user.Coms.pageCenter',{ctrl : this.ctrl});
