...
Ext.define('ui.view.user.Coms.ListGrid',{
    extend: 'ui.extend.base.Panel',
    alias: 'widget.userpagecentergrid',
    requires :[
        'ui.extend.base.Grid'
    ],
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.user.list').url;
        this.store = Ext.create( 'ui.extend.base.Store' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url     //"/Public/jsons/get.all.user.record.json",
            })
        });
//定义checkboxModel
