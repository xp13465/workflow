 ...
 */
Ext.define( 'ui.view.productscore.Coms.subTabPanel', {
    extend: 'ui.extend.base.Panel',
    alias: 'widget.productscoreviewpanel',
    layout : 'column',
    padding : 10,
    fields : [],
    autoScroll : true,
            ...
            items : [
                {
                    ...
                    height: 30,
                    handler : function(){
                        var filedpanel =  me.getFieldPanel.call( me,{field_id:"",field_type:"",field_option:"" , group_id : me.group_id } );
    ...
    getFieldPanel : function(filedconf){
        ...
        var editbutton = Ext.create( "Ext.button.Button",{
            ...
            handler : function(){
                ...
                if( btn.opmode === 'view' ){
                    ...
                    Ext.apply(postdata,{id : btn.field_id});
                    ctrl.__edit_group_field_by_id.call(ctrl,postdata , function(back){
                        if(back.status == 1){
        ...
        var addbutton = Ext.create( "Ext.button.Button",{
            ...
            handler : function(btn){
                ...
                Ext.apply(postdata,{group_id : btn.group_id});
                me.ctrl.__add_group_field_by_data.call(me.ctrl , postdata ,function(back){
                    if(back.status == 1){
                        ...
                        for(var j in btns){
                            btns[j].field_id = backdata.field_id ;
                            btns[j].group_id = backdata.group_id ;
        ...
        var fieldPanel = Ext.create("ui.extend.base.Form" , {
            ...
            margin: "5 0",
            theData : filedconf,
            items : [fieldtitle , fieldtype , fieldoption , addbutton , editbutton , canelbutton , delbutton],
            listeners :　{
