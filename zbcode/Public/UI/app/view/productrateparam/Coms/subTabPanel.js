 ...
 */
Ext.define( 'ui.view.productrateparam.Coms.subTabPanel', {
    ...
    getFieldPanel : function(filedconf){
        ...
        var canelbutton = Ext.create( "Ext.button.Button",{
            ...
            handler : function(btn){
                ...
                var fileds = fieldPanel.queryBy(function(){
                    return this.myStamp == 'field'?true:false;
                });
                for(var i in fileds){
                    ...
                    if(fileds[i].name == 'categoryo_id') fileds[i].setValue(filedconf.category_id);
                ...
                if( btn.opmode === 'view' ){
                    ...
                    ctrl.__edit_category_field_by_id.call(ctrl,postdata , function(back){
                        if(back.status == 1){
                            ...
                            if(postdata.category_id) fieldPanel.theData.category_id = filedconf.category_id;
                            btn.opmode = 'view';
                            btn.setText('编辑');
                            filedPnale.setBorder(0);
            ...
            handler : function(btn){
                ...
                me.ctrl.__add_category_field_by_data.call(me.ctrl , postdata ,function(back){
                    if(back.status == 1){
                        ...
                        //if(postdata.field_option) fieldPanel.theData.field_option = postdata.field_option;
                        if(postdata.field_name) fieldPanel.theData.field_name = postdata.field_name;
                        if(postdata.category_id) fieldPanel.theData.categoryo_id = filedconf.category_id;
                        //if(postdata.field_type) fieldPanel.theData.field_type = postdata.field_type;
                        filedPnale.setBorder(0);
        ...
        if(this.opType==='edit'){
            var typeField=[fieldtitle , addbutton , editbutton , canelbutton , delbutton];
        }else{
            var typeField=[fieldtitle];
        }
